...
void Keypad::transitionTo(byte idx, KeyState nextState) {
	...
	if (single_key)  {
	  	if ( (keypadEventListener!=NULL) && (idx==0) )  {
			keypadEventListener(key[0].kchar , p_parent);  //pass pointer to the parent of this Keypad object. - GB
		}
	}
	...
	// Calls keypadEventListener on any key that changes state.
	  	...
	  	if (keypadEventListener!=NULL)  {
			keypadEventListener(key[idx].kchar, p_parent); //pass pointer to the parent of this Keypad object. - GB
		}
	}
}
/*
